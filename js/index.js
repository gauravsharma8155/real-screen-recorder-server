...
let onExt = false;
document.getElementById("open_pop").addEventListener("click", () => {
    console.log("firskkdwkdw")
    let a = document.querySelector(".Conditions_data");
    a.style.display = 'block';


})
let local_value1 = localStorage.getItem("condition");
console.log(local_value1);
...
document.getElementById("btn_agree").addEventListener("click", (e) => {
    let check_box_open = document.getElementById("check_box_open");
    if (check_box_open.checked) {
        localStorage.setItem("condition", true);
    }

    let local_value = localStorage.getItem("condition");
